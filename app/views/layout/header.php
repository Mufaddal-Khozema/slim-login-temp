...
<body id="app" class="w-full h-full bg-gray-50 text-gray-500">
<nav class="text-gray-300  w-full bg-gray-900 h-16 p-4 flex justify-between">
  <a href="." class="flex">
  ...
  <div class="inline flex items-center">
    ...
    <a href="login"><button class="p-1 px-3 mr-3 rounded shadow-md bg-violet-600 hover:bg-violet-700 active:bg-violet-800 focus:outline-none focus:ring focus:ring-gray-`00">Login</button></a>
  </div>
</nav>
